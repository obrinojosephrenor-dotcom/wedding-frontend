      ...
      <div className="flex flex-col items-center flex-shrink-0">
        ...
        {!last && (
          <div
            ...
            style={{ background: "rgba(200,169,110,0.25)", minHeight: "40px" }}
          />
        )}
      </div>
      {/* Content */}
...
export default function Details() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:   "We recommend arriving at least 20–30 minutes before the ceremony start time to get seated comfortably. The doors will open 45 minutes prior.",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <div className="max-w-2xl mx-auto px-4 py-12 space-y-14">
        ...
        <Section>
          ...
          <DetailCard>
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { icon: "✦", label: "Venue",   value: WEDDING.ceremony.venue },
                { icon: "📍", label: "Address", value: WEDDING.ceremony.address },
                { icon: "🕐", label: "Time",    value: WEDDING.ceremony.time },
                { icon: "👗", label: "Attire",  value: WEDDING.dresscode },
              ].map((item, i) => (
                <div key={i}>
          ...
          <DetailCard style={{ background: "#FAF0E8" }}>
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                { label: "Note",    value: "Dinner, dancing & celebration!" },
              ].map((item, i) => (
                <div key={i}>
                  <p className="font-sans text-champagne text-xs tracking-widest uppercase mb-1">
                    {item.label}
        ...
        <Section delay={0.1}>
          ...
          <DetailCard>
            ...
            <TimelineItem
              time="5:00 PM"
              title="Cocktail Hour"
              description="Mingle and enjoy canapés while the couple takes photos."
            />
            <TimelineItem
        ...
        <Section delay={0.1}>
          ...
          <DetailCard style={{ background: "#F4F7F0" }}>
            <div className="text-center mb-6">
              <p className="font-script italic text-espresso/70 text-xl mb-2"
                style={{ fontWeight: 300 }}>
                Garden Formal
              </p>
              <p className="font-sans text-espresso/50 text-xs leading-relaxed max-w-sm mx-auto">
                Elegant garden attire in soft florals and earth tones.
                Ladies: floral dresses, chic jumpsuits, elegant midi dresses.
            ...
            <div
              ...
              style={{ background: "rgba(201,169,110,0.08)", border: "1px solid rgba(200,169,110,0.2)" }}
            >
              <p className="font-sans text-espresso/50 text-xs">
                ✦ Please avoid wearing <strong>white, ivory, or black</strong> out of respect for the couple ✦
              </p>
            </div>
          </DetailCard>
        </Section>
        ...
        {/* ── PARKING ──────────────────────────────────────────── */}
        <Section delay={0.1}>
          <SectionHeading eyebrow="Getting Here" title="Parking & Transport" />
          <DetailCard>
            <div className="space-y-5">
              {[
                {
                  title:       "Ceremony Parking",
                  description: "Free on-site parking is available at the ceremony venue. Enter via the main gate on Bloom Street. Overflow parking on the adjacent lot.",
                  icon:        "🅿️",
                },
                {
                  title:       "Reception Parking",
                  description: "Complimentary valet parking is provided at the reception venue. Self-parking also available in the building basement.",
                  icon:        "🚗",
                },
                {
                  title:       "Shuttle Service",
                  description: "A complimentary shuttle runs between the ceremony and reception every 20 minutes from 4:30 PM to 7:00 PM.",
                  icon:        "🚌",
                },
                {
                  title:       "Ride Share",
                  description: "Grab and Angkas drop-off points are marked at the main entrance of both venues.",
                  icon:        "📱",
                },
              ].map((item, i) => (
                <div
                ...
                >
                  ...
                  <div>
                    <p className="font-serif text-espresso/85 text-sm mb-1">{item.title}</p>
                    <p className="font-sans text-espresso/50 text-xs leading-relaxed">{item.description}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <Section delay={0.1}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              >
                <DetailCard className="h-full" style={{ background: i % 2 === 0 ? "#FAF6F0" : "#FAF0E8" }}>
                  <p className="font-sans text-champagne/70 text-xs mb-1">{hotel.stars}</p>
                  <p className="font-serif text-espresso/85 text-sm mb-1">{hotel.name}</p>
                  <p className="font-sans text-espresso/45 text-xs mb-2">{hotel.distance}</p>
                  <p
        ...
        <Section delay={0.1}>
          ...
          <DetailCard className="overflow-hidden p-0">
            ...
            <iframe
              ...
              src={`https://maps.google.com/maps?q=${encodeURIComponent(WEDDING.ceremony.address)}&output=embed`}
              width="100%"
              height="320"
            ...
            <div className="px-6 py-4 flex flex-col sm:flex-row gap-3">
                ...
                href={`https://maps.google.com/?q=${encodeURIComponent(WEDDING.ceremony.address)}`}
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                href={`https://maps.google.com/?q=${encodeURIComponent(WEDDING.reception.address)}`}
                target="_blank"
                rel="noreferrer"
                className="flex-1 text-center py-2.5 rounded font-sans text-xs tracking-[0.3em] uppercase transition-all"
                style={{
        ...
        <Section delay={0.1}>
          ...
          <DetailCard className="text-center">
            ...
            <div className="relative z-10">
              ...
              <p className="font-script italic text-espresso/60 text-lg mb-5"
                style={{ fontWeight: 300 }}>
